...
// related_blogs
const related_blogs = blogData
  .filter((b) => b.blog === "blog-grid")
  .slice(0, 3);
  ...
  return (
    <>
      <section className="tp-postbox-details-area pb-120 pt-95">
              ...
              <div className="tp-postbox-details-main-wrapper tp-postbox-style2">
                <div className="tp-postbox-details-content">
                  <p className="tp-dropcap">
                    sales process is critically important to the success of your
                    reps and your business. If you have never seen a really
                    skilled salesperson work, it seems almost effortless. They
                    ask great questions, craftt perfect proposal, answer
                    questions, address concerns and seamlessly seal the
                    Underneath the surface of all of that, the salesperson has
                    probably dedicated hours honing their craft and ensuring the
                    process moves smoothly.
                  </p>

                  <p>
                    One of the challenges that often surfaces when working with
                    a remote sales team is a lack of transparency over what is
                    happening, and where in the process things are taking place.
                    We’re going to peel back the curtain and show you how to
                    create the best sales.
                  </p>
                  ...
                  <p>
                    ...
                    penatibus magnis dis parturient montes lorem, nascetur
                    ridiculus mus. Donec quam felis, ultricies nec, pellentesque
                    euro, pretium, sem. Nulla onsequat massa quis enim. donec
                  ...
                  <div className="tp-postbox-details-desc-thumb text-center">
                    ...
                    <span className="tp-postbox-details-desc-thumb-caption">
                      Gucci’s Women’s Cruise Collection 2023 Lookbook Has
                      Arrived
                    </span>
                  </div>
                  <p>
                    “We’re so glad we’ll be working with you to get your new
                    marketing strategy up and running. I have attached the
                    details of your package. Next you’ll get an email from Jen
                    to schedule your kick-off meeting and be assigned your
                    account rep. During your kick-off meeting, we will introduce
                    your project team, let you know what access we need to
                    start.”{" "}
                  </p>
                  ...
                  <div className="tp-postbox-details-quote">
                    <blockquote>
                      ...
                      <p>
                        ...
                        puzzle its just a matter of finding it.
                      </p>
                  ...
                  <p>
                    ...
                    ridiculus mus. Donec quam felis, ultricies nec, pellentesque
                    euro, pretium quis, sem. Nulla onsequat massa quis enim.
                  </p>
                  ...
                  <p>
                    ...
                    dictum felis eu pede mollis pretium. Integer cidunt. Cras
        ...
        <div
          className="tp-postbox-related-area pt-115 pb-90 mb-110"
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="tp-postbox-details-comment-wrapper">
                <h3 className="tp-postbox-details-comment-title">
                  Comments (2)
                </h3>
                {/* BlogDetailsComments */}
                <BlogDetailsComments />
